...
{ 
public class DACSQLFactory : DACAbstracFactory 
{ 
	...
	public override DataSet ExecuteDataset(ref DACRequest Request) 
	{ 
	...
	public override int ExecuteNonQuery(ref DACRequest Request) 
	{ 
		string connectionString = Request.ConnectionString; 
		if ((connectionString == null || connectionString.Length == 0)) 
		{ 
	...
	public override object ExecuteScalar(ref DACRequest Request) 
	{ 
		string connectionString = Request.ConnectionString; 
		if ((connectionString == null || connectionString.Length == 0)) 
		{ 
    ...
    public override DACDataReader ExecuteReader(ref DACRequest Request) 
	{ 
		DACSQLDataReader oDataReaderSQL; 
		...
		{ 
			...
			oDataReaderSQL = new DACSQLDataReader(); 
	...
	public override void FillDataset(ref DACRequest Request) 
	{ 
		string connectionString = Request.ConnectionString; 
		if ((connectionString == null || connectionString.Length == 0)) 
		{ 
	...
	public override void UpdateDataSet(ref DACRequest RequestInsert, ref DACRequest RequestUpdate, ref DACRequest RequestDelete) 
	{ 
